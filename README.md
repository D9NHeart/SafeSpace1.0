# SafeSpace1.0
# 🌿 SafeSpace — Mental health tracker
...
> Na primeira execução o arquivo `safespace.db` é criado automaticamente na pasta do projeto. Nenhuma configuração adicional é necessária. (Iara lembre de não rodar o projeto com cobol)
