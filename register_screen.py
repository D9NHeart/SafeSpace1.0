...
class RegisterScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        with ScrollableContainer(id="register-container"):
            ...
            yield Input(placeholder="Como posso te chamar?", id="name-input")
    ...
    def _clear_errors(self) -> None:
        for widget_id in ["name-error", "email-error", "password-error", "confirm-error", "phone-error", "global-error", "global-success"]:
